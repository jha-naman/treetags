#!/usr/bin/env bash
#
# Build treetags plugins and generate the index/site content.
#
# No credentials required — safe to run in a container. Publishing the built
# blobs to GitHub is a separate, credentialed step: scripts/publish-plugins.sh.
#
# Pipeline:
