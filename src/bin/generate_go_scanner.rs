...
fn token_table(prefix: &str, values: &BTreeSet<String>) -> String {
    values
        .iter()
...
{}];
pub const LEXICON:GeneratedLexicon=GeneratedLexicon{{identifier:IDENTIFIER,literal:LITERAL,unknown:UNKNOWN,keywords:KEYWORDS,punctuation:PUNCTUATION}};
